...
class SourceItem(BaseModel):
    """Individual source item with text and optional URL"""
    text: str
...
class QueryResponse(BaseModel):
    ...
    answer: str
    sources: Union[List[str], List[SourceItem]]  # Support both old and new format
    session_id: str
...
async def query_documents(request: QueryRequest):
    ...
    try:
        ...
        # Convert source objects to SourceItem models if they're dictionaries
        formatted_sources = []
